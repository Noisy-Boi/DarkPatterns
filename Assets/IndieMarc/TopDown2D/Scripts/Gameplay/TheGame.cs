...
namespace IndieMarc.TopDown
{
    public class TheGame : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //Pause cinematic
            if (DialogueSystem.NarrativeManager.Get())
            {
                DialogueSystem.NarrativeManager.Get().OnDialogueStart += (DialogueSystem.DialogueEvent e) => { Pause(); };
                DialogueSystem.NarrativeManager.Get().OnDialogueEnd += (DialogueSystem.DialogueEvent e) => { Unpause(); };
            }
